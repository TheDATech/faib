...
export const CompanyContactForm2 = () => {
  const {UserData,userdataLoad}=useAuthContext();
  let navigate = useNavigate();
 
const getRmoveLink=()=>{
  navigate('/required-form2');
}
        ...
        First Aid Training Provider
          ...
          >
            <Box>
              ...
              <br />
              <input className={style.form_input} type="text" name="country_two" value={UserData.country_two}/>
            </Box>
          </Box>
          </Box>

          <div className="mt-3"><Button className={style.continue_btn} type="submit" onClick={getRmoveLink}>Continue</Button></div>
        </Box>
        </form>
      </Box>
    </div>
